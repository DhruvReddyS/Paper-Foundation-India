...
export default function TruthPressGame() {
  ...
  return (
    <GameFrame gameId="truth-press" immersive={phase === "play"} title="The Truth Press" kicker="Game 02 · Claim investigation" progress={phase === "play" ? ((index + (selected ? 1 : 0)) / claims.length) * 100 : undefined}>
