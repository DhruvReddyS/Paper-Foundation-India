...
const results = [
  { type: "Article", title: "How fibre sourcing shapes the paper story", excerpt: "Follow the evidence behind forest management, fibre origin and the limits of a material label.", href: "/knowledge/sustainable-forestry-makes-paper-renewable", terms: "forest forestry source trees fresh fibre" },
  { type: "Article", title: "Reading recovery rates without losing the fibre story", excerpt: "Collection, contamination, yield and final use all sit behind a headline recycling number.", href: "/knowledge/after-the-paper-bin", terms: "recycling recovery collection contamination fibre" },
  { type: "Article", title: "What life-cycle studies answer, and what they do not", excerpt: "Use boundaries and methods to read comparisons between paper and other systems responsibly.", href: "/knowledge/paper-vs-plastic-beyond-headlines", terms: "lifecycle lca plastic comparison method" },
