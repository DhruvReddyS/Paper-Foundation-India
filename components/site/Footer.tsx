...
const columns=[
 ...
 {label:"India & Foundation",links:[["India Fibre Map","/india-map"],["India by Numbers","/india-snapshot"],["About the Foundation","/about"],["Join the Initiative","/get-involved"]]},
] as const;
...
export default function Footer(){return <footer className={styles.footer}>
 ...
 <div className={styles.callout}><div><p>The next page is not blank.</p><h2>It is waiting for<br/><em>what we choose.</em></h2></div><Link href="/get-involved">Join Paper Foundation India <ArrowUpRight/></Link></div>
