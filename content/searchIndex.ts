...
const pages: SiteSearchEntry[] = [
  ...
  { id: "page-map", label: "India Fibre Atlas", href: "/india-map", type: "Page", description: "Explore India’s fibre hubs and state demand model.", keywords: "india states map fibre mills demand" },
  { id: "page-snapshot", label: "India Paper Ledger", href: "/india-snapshot", type: "Page", description: "Production, recovery, trade, packaging and employment indicators.", keywords: "statistics charts data recycling production trade jobs packaging" },
